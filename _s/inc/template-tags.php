...
function grunted_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'grunted' ); ?></h1>
		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'grunted' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'grunted' ) ); ?></div>
			<?php endif; ?>
...
if ( ! function_exists( 'grunted_posted_on' ) ) :
/**
...
function grunted_categorized_blog() {
	...
	if ( $all_the_cool_cats > 1 ) {
		...
		// This blog has only 1 category so grunted_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in grunted_categorized_blog.
 */
